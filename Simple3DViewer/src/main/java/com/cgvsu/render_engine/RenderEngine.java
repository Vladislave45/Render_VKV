...
public class RenderEngine {
    ...
    public static void render(
        ...
        if (isRasterizationEnabled) {
            renderWithRasterization(graphicsContext, camera, mesh, width, height, modelViewProjectionMatrix, texture, fillColor);
        } else {
    ...
    private static void rasterizeTriangle(
        ...
        TriangleRasterization.drawTriangle(gc, triangle2D, texture, t1, t2, t3, zBuffer, v1_3d, v2_3d, v3_3d, vertexNormals, camera, fillColor, width, height);
    }
